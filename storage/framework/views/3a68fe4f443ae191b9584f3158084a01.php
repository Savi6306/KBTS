...
<body style="font-family: Arial, sans-serif; background: #f3f4f6; padding: 20px;">
    <div style="max-width: 600px; margin: auto; background: white; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 20px;">
            ...
            <p><strong>Ticket Subject:</strong> <?php echo e($ticket->subject); ?></p>

            <a href="<?php echo e(url('/user/tickets/'.$ticket->id)); ?>"
...
<?php /**PATH C:\xampp\htdocs\kbts\resources\views/mail/agent_reply.blade.php ENDPATH**/ ?>