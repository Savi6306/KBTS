...
<div class="welcome-card mb-4">
    <h4 class="fw-bold mb-1">Hello, <?php echo e(Auth::user()->name); ?> 👋</h4>
...
<div class="row g-4">
    ...
    <div class="col-md-4">
        <div class="stats-card">
            ...
            <div class="stats-number primary"><?php echo e($totalTickets); ?></div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="stats-card">
            ...
            <div class="stats-number warning"><?php echo e($pendingTickets); ?></div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="stats-card">
            ...
            <div class="stats-number success"><?php echo e($resolvedTickets); ?></div>
        </div>
    </div>
...
<div class="row g-4 mb-4">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('user.tickets.create')); ?>" class="text-decoration-none">
            <div class="quick-box">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('user.tickets.index')); ?>" class="text-decoration-none">
            <div class="quick-box">
    ...
    <div class="col-md-4">
        <a href="<?php echo e(route('user.kb.index')); ?>" class="text-decoration-none">
            <div class="quick-box">
...
<div class="row g-4">
            ...
            <table class="table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="badge-status status-<?php echo e(strtolower($t->status)); ?>"><?php echo e($t->status); ?></span></td>

                        <td><span class="badge-status priority-<?php echo e(strtolower($t->priority)); ?>"><?php echo e($t->priority); ?></span></td>

                        <td>
                            <a href="<?php echo e(route('user.tickets.show', $t->id)); ?>" class="view-btn">View</a>
                        </td>
                    </tr>
    ...
    <div class="col-md-6">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $recentReplies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="reply-card">
            <div class="reply-user"><?php echo e($reply->user->name); ?></div>
            <div class="reply-msg"><?php echo e(Str::limit($reply->content, 120)); ?></div>
...
<?php echo $__env->make('user.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\kbts\resources\views/user/dashboard.blade.php ENDPATH**/ ?>